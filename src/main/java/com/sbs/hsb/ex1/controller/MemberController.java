...
//		Map<String, Object> newParam = Util.getNewMapOf(param, "title", "body", "fileIdsStr");
	...
	public String doLogin(String loginId, String loginPwReal, String redirectUri, Model model, HttpServletRequest req,
			HttpSession session) {
	...
	public String showMemberModify(Model model, HttpSession session) {
		int loginedMemberId = (int) session.getAttribute("loginedMemberId");
...
//	}
	...
	public String showMyInfo(Model model, HttpSession session) { // HttpServletRequest req,
		int loginedMemberId = (int) session.getAttribute("loginedMemberId");
		String authCode = memberService.genEmailAuthCode(loginedMemberId);
