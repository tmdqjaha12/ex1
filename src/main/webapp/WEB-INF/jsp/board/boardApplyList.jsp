...
<div class="create-board con" style="background-color: #ebebf1;">
	<div class="backA" style="background-color:white;">
			...
			<tbody class="table-tbody">
				...
				<c:forEach items="${BoardApplyDocs}" var="BoardApplyDoc">
					<tr>
						...
						<td class="text-center regdate">${BoardApplyDoc.regDate}</td>
						...
						<td class="" style="padding-left: 5px;">
							...
							<form action="doBoardApply" method="POST">
								...
								<input style="width:100%;" type="submit" value="승인" onclick="if ( confirm('승인하시겠습니까?') == false ) return false;" />
							</form>
							...
							<form action="doBoardReject" method="POST">
								...
								<input type="hidden" name="redirectUri" value="/usr/board/boardApplyList">
								<input style="width:100%;" type="submit" value="거절" onclick="if ( confirm('거절하시겠습니까?') == false ) return false;" />
							</form>
						</td>
					</tr>
				</c:forEach>
